...
/** updatePictureIntroduction POST /api/timeAlbum/picture/update-introduction */
export async function updatePictureIntroductionUsingPost(
  body: API.UpdatePictureIntroductionRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/timeAlbum/picture/update-introduction', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
