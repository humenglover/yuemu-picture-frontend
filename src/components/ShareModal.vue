...
const PETS = [
  {
    ...
    url: 'https://assets2.lottiefiles.com/packages/lf20_9ycwmgb6.json'
  },
  {
    name: 'happy-dog',
    url: 'https://assets5.lottiefiles.com/packages/lf20_buhby0ug.json'
  },
  {
    name: 'dancing-duck',
    url: 'https://assets1.lottiefiles.com/packages/lf20_ky24lkyk.json'
  }
]
